...
(function (global) {
  ...
  function buildEventLines(assignment) {
    ...
    const courseName = (assignment.courseName || "").trim() || "Gradescope";
  ...
  // Accepts either:
  //   - a flat array of assignments: buildICS([{ courseName, name, dueISO, ... }, ...])
  ...
  function buildICS(input) {
    ...
    if (calNameHint) {
      ...
      calName = "Gradescope (" + uniqueCourses.length + " courses)";
    } else {
      calName = "Gradescope";
    }
